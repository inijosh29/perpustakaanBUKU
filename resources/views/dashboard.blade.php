<x-layouts.app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-10 p-6 bg-gray-50">
        ...
        <!-- HEADER -->
       <div
    class="relative overflow-hidden rounded-2xl px-8 pt-10 pb-32 text-gray-800 shadow-xl"
    style="background: linear-gradient(135deg, #34d399, #a7f3d0, #FFFAD9);"
>
    <!-- decorative blur -->
    <div class="absolute -top-20 -right-20 h-72 w-72 rounded-full bg-white/20 blur-3xl"></div>

    <div class="relative flex flex-col items-center justify-center gap-4 text-center">
        <h1
            class="text-4xl tracking-tight text-emerald-900"
            style="font-family: 'WelcomeFont', sans-serif;"
        >
            Selamat Datang
        </h1>
        ...
        <div class="relative -mt-24 grid gap-6 md:grid-cols-3 z-10">
           ...
           <div
    class="group rounded-2xl p-6 shadow-md ring-1 ring-gray-200 transition-all
           hover:-translate-y-1 hover:shadow-xl"
    style="background-color: #FFFAD9;">
